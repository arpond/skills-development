...
- **Re-ground, don't cache.** Judgments (priorities, rejected ideas, plans) can go stale as a
...
- **Reasons over blacklists.** When something gets declined, record *why*, not just *that* it
  ...
  rejected for timing, not substance -- the reason is what lets a future judgment call be made
  correctly.
